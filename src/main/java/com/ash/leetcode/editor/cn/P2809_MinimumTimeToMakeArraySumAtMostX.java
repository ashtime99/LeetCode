...
// 
//
// Related Topics 数组 动态规划 排序 👍 54 👎 0
...
/**
 * P2809.使数组和小于等于 x 的最少时间
 *
 * @author ash
 * @since 2024-01-19 10:36:43
 */
public class P2809_MinimumTimeToMakeArraySumAtMostX {
...
// leetcode submit region end(Prohibit modification and deletion)
    ...
    public static void main(String[] args) {
        Solution solution = new P2809_MinimumTimeToMakeArraySumAtMostX().new Solution();
    }
}
