...
// 
//
// Related Topics 栈 字符串 模拟 👍 47 👎 0

/**
 * P2696.删除子串后的字符串最小长度
 *
 * @author ash
 * @since 2024-01-10 21:19:17
 */
public class P2696_MinimumStringLengthAfterRemovingSubstrings {
    ...
    class Solution {
        public int minLength(String s) {
            ...
            if (s.length() == 2) {
                if ((s.charAt(0) == 'A' && s.charAt(1) == 'B') || (s.charAt(0) == 'C' && s.charAt(1) == 'D')) {
                    return 0;
                }
            }
            return s.length();
...
// leetcode submit region end(Prohibit modification and deletion)
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.minLength("CCDDLLDW"));
    }
}
